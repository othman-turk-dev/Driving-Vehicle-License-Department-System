...
namespace DVLD_DataAccessLayer
{
    ...
    {
        public static int AddNewLicenses(int ApplicationID, int DriverID, int LicenseClass, DateTime IssueDate, DateTime ExpirationDate,
        ...
        public static bool GetLicensesByLicenseID(int LicenseID, ref int ApplicationID, ref int DriverID, ref int LicenseClass,
        ...
        public static int GetActiveLicenseIDByPersonID(int PersonID, int LicenseClassID)
        {
            ...
            string query = @"SELECT        Licenses.LicenseID
                            ...
                            AND
                            Drivers.PersonID = @PersonID And IsActive=1;";
        ...
        public static bool IsPersonHaveAnyLicense(int PersonID)
        {
